...
- Added a "Free shipping on orders overs R500" text.
...
- Used CSS pseudo-classes like `:focus`, and `:active` to create interactive elements.
- Used CSS property `line-height`, and `letter-spacing` to style text elements.
- Used a CSS reset to ensure consistent styling across different browsers.
- When you tap on which page you want to go to on the navigation bar,the name of the page that you have selected turns pink.
- When you go to tap "view" on a product,the "view" button now turns blue when being hovered over.
- Mobile view improvements are now in place.The site looks much better on phones and tablets now as shown below:
...
- Shein - for the shipping info and return and refund policy inspiration.
- https://za.shein.com
